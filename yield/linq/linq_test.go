...
func TestOnce(t *testing.T) {
	{
		xs := Of(1, 2, 3)
		ys := Select(xs, Id[int])
		assertEqual(t, ys.ToSlice(), []int{1, 2, 3})

		zs := Select(xs, Id[int])
		assertEqual(t, len(zs.ToSlice()), 0)
	}
...
func TestSelect(t *testing.T) {
	xs := Of(1, 2, 3)
	ys := Select(xs, square)
	assertEqual(t, ys.ToSlice(), []int{1, 4, 9})
}
...
func TestRange(t *testing.T) {
	xs := Range(1, 10)
	assertEqual(t, xs.ToSlice(), []int{1, 2, 3, 4, 5, 6, 7, 8, 9})
}

func TestWhere(t *testing.T) {
	xs := Range(1, 10)
	ys := Where(xs, isEven)
	assertEqual(t, ys.ToSlice(), []int{2, 4, 6, 8})
}
...
func TestSkip(t *testing.T) {
	...
	assertEqual(t, ys.ToSlice(), []int{6, 8})
}

func TestSkipWhile(t *testing.T) {
	xs := Range(1, 10)
	ys := SkipWhile(xs, lt(5))
	assertEqual(t, ys.ToSlice(), []int{5, 6, 7, 8, 9})
}
...
func TestSkipWhileWithIndex(t *testing.T) {
	...
	assertEqual(t, ys.ToSlice(), []int{6, 7, 8, 9})
}
...
func TestTake(t *testing.T) {
	...
	assertEqual(t, ys.ToSlice(), []int{2, 4, 6})
}

func TestTakeWhile(t *testing.T) {
	xs := Range(1, 10)
	ys := TakeWhile(xs, lt(5))
	assertEqual(t, ys.ToSlice(), []int{1, 2, 3, 4})
}
...
func TestTakeWhileWithIndex(t *testing.T) {
	...
	assertEqual(t, ys.ToSlice(), []int{1, 2, 3, 4, 5})
}
...
func TestAllEx(t *testing.T) {
	...
	assertEqual(t, names.ToSlice(), []string{
		"Haas",
		"Antebi",
	})
}
...
func TestAppend(t *testing.T) {
	...
	assertEqual(t,
		strings.Join(Select(Of(xs...), strconv.Itoa).ToSlice(), ", "),
		"1, 2, 3, 4",
	)
	assertEqual(t,
		strings.Join(Select(ys, strconv.Itoa).ToSlice(), ", "),
		"1, 2, 3, 4, 5",
	)
}
